                  ...
                  <tr>
                    ...
                    ?>
                       <tr>
                            ...
                            <td class="ratec"><?php $rate = get_post_meta($post->ID, 'Rating', true); echo $rate; ?>
                            <input type="text" class="ids" value="<?php echo $rate;?>">
                            <ul class="gallery">
        <li data-id="1">
