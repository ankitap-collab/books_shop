                  ...
                  <tr>
                    ...
                    ?>
                       <tr>
                            ...
                            <td class="ratec"><?php $rate = get_post_meta($post->ID, 'Rating', true);  ?>
                            <span class="rateset"><?php echo $rate;?></span>
