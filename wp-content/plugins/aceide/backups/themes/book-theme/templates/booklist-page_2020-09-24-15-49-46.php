...
?>
  <tr>
    ...
    <td> <?php echo get_post_meta($post->ID, 'Price', true); ?></td>
						...
						<?php 
		$terms = get_terms( array('taxonomy' => 'authors','hide_empty' => false) ); 
    ...
    <?php }  ?>
    	...
    	<?php 
		$terms = get_terms( array('taxonomy' => 'publisher','hide_empty' => false) ); 
		foreach($terms as $term) {
	?>
