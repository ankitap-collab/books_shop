        ...
        <div class="container">
        	...
        	if ( have_posts() ) {
        		...
        		while ( have_posts() ) {
        		    ...
        		    <?php the_content();?>
        		    <h5>Ratings : </h5> <?php	echo get_post_meta($post->ID, 'Rating', true);  ?>
        		    <h5>Price : </h5>  <?php 	echo get_post_meta($post->ID, 'Price', true); ?>
